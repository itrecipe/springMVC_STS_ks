...
public class BookController {
	...
	public String searchBookConfirm(BookVo bookVo, Model model) {
		System.out.println("[user.UserBookController] searchBookConfirm() 호출!");
	...
	public String bookDetail(@RequestParam("b_no") int b_no, Model model) {
		System.out.println("[user.UserBookController] bookDetail() 호출!");
	...
	public String rentalBookConfirm(@RequestParam("b_no") int b_no, HttpSession session) {
		System.out.println("[user.UserBookController] rentalBookConfirm() 호출!");
	...
	public String enterBookshelf(HttpSession session, Model model) {
		System.out.println("[user.UserBookController] enterBookshelf() 호출!");
	...
	public String listupRentalBookHistory(HttpSession session, Model model) {
		System.out.println("[user.UserBookController] listupRentalBookHistory() 호출!");
	...
	public String requestHopeBookForm() {
		System.out.println("[user.UserBookController] requestHopeBookForm() 호출!");
	...
	public String requestHopeBookConfirm(HopeBookVo hopeBookVo, HttpSession session) {
		System.out.println("[user.UserBookController] requestHopeBookConfirm() 호출!");
	...
	public String listupRequestHopeBook(HttpSession session, Model model) {
		System.out.println("[user.UserBookController] listupRequestHopeBook() 호출!");

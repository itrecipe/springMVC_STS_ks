...
public class BookDao {
	...
	public boolean isISBN(String b_isbn) {
		System.out.println("[admin.BookDao] isISBN()!");
	...
	public int insertBook(BookVo bookVo) {
		System.out.println("[admin.BookDao] insertBook()!");
	...
	public List<BookVo> selectBooksBySearch(BookVo bookVo) {
		System.out.println("[admin.BookDao] selectBooks()!");
	...
	public BookVo selectBook(int b_no) {
		System.out.println("[admin.BookDao] selectBook()!");
	...
	public int updateBook(BookVo bookVo) {
		System.out.println("[admin.BookDao] updateBook() 요청!");
	...
	public int deleteBook(int b_no) {
		System.out.println("[admin.BookDao] deleteBook() 요청!");
	...
	public List<RentalBookVo> selectRentalBooks() {
		System.out.println("[admin.BookDao] selectRentalBooks()!");
		...
		try {
			...
			rentalBookVos = jdbcTemplate.query(sql, new RowMapper<RentalBookVo>() {
				...
				public RentalBookVo mapRow(ResultSet rs, int rowNum) throws SQLException {
					...
					rentalBookVo.setU_m_no(rs.getString("u_m_no"));
	...
	public int updateRentalBook(int rb_no) {
		System.out.println("[admin.BookDao] updateRentalBook()!");
	...
	public int updateBook(int b_no) {
		System.out.println("[admin.BookDao] updateBook()!");
	...
	public List<HopeBookVo> selectHopeBooks() {
		System.out.println("[admin.BookDao] selectHopeBooks()!");
	...
	public void updateHopeBookResult(int hb_no) {
		System.out.println("[admin.BookDao] updateHopeBookResult()!");
	...
	public List<BookVo> selectAllBooks() {
		System.out.println("[admin.BookDao] selectAllBooks()!");

...
public class BookDao {
	...
	public List<BookVo> selectBooksBySearch(BookVo bookVo) {
		System.out.println("[user.BookDao] selectBooksBySearch()!");
	...
	public BookVo selectBook(int b_no) {
		System.out.println("[user.BookDao] selectBook()!");
	...
	public int insertRentalBook(int b_no, int u_m_no) {
		System.out.println("[user.BookDao] insertRentalBook()!");
	...
	public void updateRentalBookAble(int b_no) {
		System.out.println("[user.BookDao] updateRentalBook()!");
	...
	public List<RentalBookVo> selectRentalBooks(int u_m_no) {
		System.out.println("[user.BookDao] selectRentalBooks()!");
	...
	public List<RentalBookVo> selectRentalBookHistory(int u_m_no) {
		System.out.println("[user.BookDao] selectRentalBookHistory()!");
	...
	public int insertHopeBook(HopeBookVo hopeBookVo) {
		System.out.println("[user.BookDao] insertHopeBook()!");
	...
	public List<HopeBookVo> selectRequestHopeBooks(int u_m_no) {
		System.out.println("[user.BookDao] selectRequestHopeBooks()!");
